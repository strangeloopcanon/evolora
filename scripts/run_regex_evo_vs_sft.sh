...
Options:
  ...
  --sft-match-budget-field   One of: total_tokens,train_tokens,total_flops,train_flops,wall_clock_seconds (default: train_tokens)
  --backprop-multiplier      Convert evo budget → SFT budget (default: 2.0)
...
RUN_EVAL_ID=1
RUN_EVAL_OOD=1
SFT_MATCH_BUDGET_FIELD="train_tokens"
BACKPROP_MULTIPLIER="2.0"
